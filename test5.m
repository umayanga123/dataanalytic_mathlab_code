...
%sD = som_data_struct([D1; D2; D3],'name','Demo3 data',...'comp_names',{'X-coord','Y-coord','Z-coord'});
%sM = som_make(sD);
...
for c=1:3, 
  ...
  som_grid('rect',[218 1],'coord',Pd,'Line','none',...
...
echo off 
Col = som_normcolor([1:218]',jet(218));
k=1;
for i=1:3, 
  for j=1:3, 
    ...
    elseif i>j,
      subplot(3,3,k); cla
      som_grid('rect',[218 1],'coord',sD.data(:,[i1 i2]),...
...
%{
Dtraj = [linspace(9,2,20); linspace(0,2,20); linspace(0,2,20),linspace(0,2,20)]';
T = som_bmus(sM,Dtraj);
